...
class Generator(nn.Module):
    def __init__(self, ngf=64, nz=100, nc=1, im_size=256):
...
class Discriminator(nn.Module):
    def __init__(self, ndf=64, nc=1, im_size=256):
...
class SimpleDecoder(nn.Module):
    ...
    def __init__(self, nfc_in=64, nc=1):
...
class TextureDiscriminator(nn.Module):
    def __init__(self, ndf=64, nc=1, im_size=512):
